...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # [AG:] Derivative of y=x with respoect to x is 1.
...
##########################################################
iterations = 3000 # [AG:] number of batches of samples from the training data
learning_rate = 0.8 # [AG:] lambda. It scales th size of weight update
hidden_nodes = 14 # [AG:] The best number of hidden_nodes is between the number of input and output nodes
output_nodes = 1 
